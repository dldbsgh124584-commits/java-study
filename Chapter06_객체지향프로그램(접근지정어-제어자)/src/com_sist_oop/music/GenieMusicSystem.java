...
// *     => 다른 패키지에 있는 클래스는 인식을 못 한다
// *     => import 패키지.* : 패키지안에 있는 모든 클래스
// *         => 패키지에 있는 클래스를 여러개 사용시  
// *        import 패키지.클래스명 : 지정된 클래스 1개 가지고 온ㄷ
// *        ------------------- 권장 
// *  3. 접근지정어
// *     -------------------------------
// *      private : 데이터 은닉화
...
////			  else
////			  {
////				  state=temp.replaceAll("[^0-9]","");
////				  id=temp.replaceAll("[^가-힣]", "");
////			  }
////			  m.setState(state);
...
//	  }
//  }
//  public void singerFind(String ed)
//  {
//	  for(Music m:music)
//	  {
//		  if(m.getSinger().contains(ed))
//		  {
