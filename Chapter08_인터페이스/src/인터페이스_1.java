 ...
 *       
 *       추상클래스 / 인터페이스
 *                 |무엇을 해야할지 알려준다 => 완전한 미완성 클래스
 *       | 기본은 만들어준다 / 나머지 개발자한테 => 반쪽 미완성 클래스
 *       | 프렌차이즈 메뉴 (기본 레시피 => 매장 독자적 개발)  
 *       버튼 
 *       => 객체 생성이 안 된다(new x)
 *       => 상속 => 구현해서 사용이 가능
 *       
...
{
	public void display() {}
	public void aaa() {}  // default 를 구현해놔서 필요한 곳에서 쓰면 됨 
