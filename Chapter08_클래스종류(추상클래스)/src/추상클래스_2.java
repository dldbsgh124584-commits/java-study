 ...
 *           | 찜하기 , 좋아요 ... 
 *           
 *        => 유지보수가 어려운 경우 => 기능 설정 => 필요시마다 따로 구현
 *           ----------------
 *           설계(요구사항) => 추상클래스 / 인터페이스  
 * 
 */
 ...
 * 
 */
abstract class DBDiver
{
	public abstract void connection(); //연결
	public  void preparedStatement() {
		System.out.println("SELECT 문장 전송 => 데이터 검색");// SQL 
	}
	public abstract void disconnection(); // 닫기
	public  void getResultSet() {
		System.out.println("읽은 데이터를 저장:브라우저 전송");// 결과값 
	}
}
class Oracle extends DBDiver
{
