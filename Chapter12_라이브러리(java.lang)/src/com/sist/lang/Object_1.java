 ...
 *                   예)
 *                      Object o=10,10.5,true,"",'',new A()
 *                      ----------------------------------- 라이브러리에서 지원하는 메소드
 *                                                          메소드 : 리턴형이 Object => 형변환을 시켜야 함
 *                                                        (단점느낌)  매개변수도 Object
 *                                                          => 제네릭 (형변환 보완할 수 있음)
 *                   
 *                   => 주요 메소드
 *                      **1. finalize() : 객체소멸 => 자동 호출
 ...
 *          = List / Set / Map  
 *        = java.tx
 *          = DecimalFormat => 1,000 (콤마)
 *          = SimpleDateFormat => 2026-03-30 
 *          = ChoiceFormat => Switch 를 대체
...
class Sawon
{
    ...
    *  => 생성자
    *  => 인스턴스 메소드에서만 사용이 가능
    *  => 인스턴스 초기화 블록 / static{} static메소드에서는 사용이 안 됨
    */
   public void print()
   {
