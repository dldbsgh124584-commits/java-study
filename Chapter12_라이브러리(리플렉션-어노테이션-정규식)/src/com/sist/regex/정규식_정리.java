 ...
 *      th*         td*
 *      
 *      . : 임의의 한글자 => 오라클에서는 언더바 A___
 *      ? : 0이나 1개
 *      | : 선택
 *      {n} => n번 반복 => 갯수
 *             a{3} => aaa
 *      {n,} => n번 이상 반복
 *             a{3,} => a aa aaa aaaa aaaaa aaaaaa
 *      {n,m} => n~m 반복
 *             a{2,4} => aa aaa aaaa
 *      그룹 => (단어)
 *      ---------------------------- mathers => ture/false  
...
//        String msg="내 전화번호는 010-1234-5678"+"회사번호는 02-333-4566 입니다";
//        // 전화 번호만 추춯
...
//        }
        /*
         *     Matcher : 
         *     matchers() : 전체 문자열에서 패턴과 일지 여부 => boolean
         *     find() : 부분 일치 (패턴 형식)
         *     group() : 찾는 문자열
         *     start() :시작 인덱스
         *     end() : 끝 인덱스 
