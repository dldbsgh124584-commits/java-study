 ...
 *          
 *          A , B ,C
 *       => 메소드 구현시 10줄 이상 => 메소드 구현이 편리 (가독성X)
 * 
 */
 ...
 *      (a)-> {Math.random()*a}
 *      
 *     default 메소드 / static 메소드는 구현이 가능
 *     구현이 없는 메소드 (추상메소드) 1개만 설정
 *     
 * 
 */
public class Lamda_2 {
	...
	public static void main(String[] args) {
        ...
        System.out.println(gob.calc(10, 20));
