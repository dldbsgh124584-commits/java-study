 ...
 *                    replace() , reolaceAll() , indexOf() , lastIndexOf()
 *           Math : ceil() , random()
 *           Wrapper 
...
public class IO_1 {
	...
	public static void main(String[] args) {
		...
		try
		{
			File file=new File("C:\\javadev\\java study\\Chapter18_입출력(IO)_2\\src\\com\\sist\\io\\IO_1.java");
			...
			// setXxx => void
			// getXxx => 리턴형
			System.out.println("일기 전용:"+file.canRead());
